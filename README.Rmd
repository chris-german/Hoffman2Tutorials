...
You can learn more about Linux in Dr. Hua Zhou's *Biostat 203B: Introduction to Data Science* course.
...
Hoffman2 has Git and svn available, which offer a more productive and reproducible way to synchornize source code between computers and platforms. 
...
This shows that the biostatistics group has six  nodes (n6277 n7277 n6278 n7278 n6285 n7285), each with 12 cores (dual socket Intel Xeon X5650) and 48GB of memeory (an average of 4GB/core), and two nodes (n6444 n7405), each with 36 cores (dual socket Intel Xeon Gold 6140 CPUs) and 192GB of memory (an average of 5.3GB/core).
