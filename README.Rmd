...
Julia users might want to request an "any Intel" node. This can be achieved by adding an option of `(not arch == 'intel-\*')` to [Line 230](https://gitlab.idre.ucla.edu/dauria/jupyter-notebook/-/blob/72fb764c72441763de3da93ccb8dbbe94f0bfbe5/h2jupynb#L230) of the most recent commit of the file as of Nov 3, 2021.
