...
This shows that the biostatistics group has six nodes (n6277 n7277 n6278 n7278 n6285 n7285), each with 12 cores and 48GB of memeory (an average of 4GB/core), and two nodes (n6444 n7405), each with 36 cores and 192GB of memory (an average of 5.3GB/core).
