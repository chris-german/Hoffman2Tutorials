...
Register for an account at: [https://www.hoffman2.idre.ucla.edu/getting-started/#newuser](https://www.hoffman2.idre.ucla.edu/getting-started/#newuser)
...
```
![](Hoffman2login.png){width=450px}


and enter your password when prompted (Can also setup ssh keys so no password is required) [https://www.hoffman2.idre.ucla.edu/access/passwordless_ssh/](https://www.hoffman2.idre.ucla.edu/access/passwordless_ssh/).
